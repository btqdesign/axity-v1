                ...
                jQuery(".edit_circle_list_delete a").on("click", function () {
                    ...
                    for (var j = 0; j < circles.length; j++) {
                        ...
                        if (circleid == id) {
                            ...
                            jQuery("#hover_circle_edit_line_color")[0].jscolor.fromString(hover_line_color);
                            jQuery("#hover_circle_edit_line_opacity").simpleSlider("setValue", hover_line_opacity);
                            jQuery("#hover_circle_edit_fill_color")[0].jscolor.fromString(hover_fill_color);
                            ...
                            google.maps.event.addListener(autocomplete_edit_circle, 'place_changed', function () {
                                ...
                                geocoder.geocode({'address': addr}, function (results, status) {
                                    ...
                                    hugeitMapsUpdateCircleEditInputs(results[0].geometry.location);
                                })
                            });
