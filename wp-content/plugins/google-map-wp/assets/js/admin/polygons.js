                ...
                jQuery(".edit_polygone_list_delete a").on("click", function () {
                    ...
                    for (var e = 0; e < polygones.length; e++) {
                        ...
                        if (polygoneid == id) {
                            ...
                            jQuery("#hover_polygone_edit_line_color")[0].jscolor.fromString(hover_line_color);

                            jQuery("#hover_polygone_edit_fill_opacity").simpleSlider("setValue", hover_fill_opacity);

                            jQuery("#hover_polygone_edit_fill_color")[0].jscolor.fromString(hover_fill_color);
