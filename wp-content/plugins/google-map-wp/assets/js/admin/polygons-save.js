jQuery(document).ready(function(){
    jQuery("#polygone_submit").on("click", function () {
        ...
        var polygon_data = {
            ...
            hover_polygon_fill_opacity: hover_polygone_fill_opacity,
            hover_polygon_fill_color: hover_polygone_fill_color,
            hover_polygon_line_opacity: hover_polygone_line_opacity,
            hover_polygon_line_color: hover_polygone_line_color
        };
