jQuery(document).ready(function(){
    jQuery("#marker_submit").on("click", function () {
        ...
        if (jQuery(this).parent().parent().find(".marker_image_choose ul li.active").html() != undefined && jQuery(this).parent().parent().find(".marker_image_choose ul li.active input[type=radio]").val() != 'default') {
            marker_image = jQuery(this).parent().parent().find(".marker_image_choose ul li.active input[type=radio]").val();
            marker_image = markerSaveL10n.icons_url + marker_image + marker_image_size + ".png";
        }
        else {
            marker_image = jQuery("#marker_pic_name").val();
        }
    ...
    jQuery("#marker_edit_submmit").on("click", function () {
        ...
        var marker_edit_image;
        if (jQuery(this).parent().parent().find(".marker_image_choose ul li.active").html() != undefined && jQuery(this).parent().parent().find(".marker_image_choose ul li.active input[type=radio]").val() != 'default') {
            marker_edit_image = jQuery(this).parent().parent().find(".marker_image_choose ul li.active input[type=radio]").val();
            marker_edit_image = markerSaveL10n.icons_url + marker_edit_image + marker_edit_image_size + ".png";

        } else {
            marker_edit_image = jQuery("#marker_edit_pic").val();
        }
