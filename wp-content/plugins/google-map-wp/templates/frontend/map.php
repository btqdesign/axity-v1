...
<div class="clear-float">
    ...
    <div class="huge_it_google_map_container" >
        <div id="huge_it_google_map_<?php echo $i; ?>" data-map_id="<?php echo $map->get_id(); ?>"
             class="hide huge_it_google_map" style="<?php echo $styles; ?>"
             data-name="<?php echo esc_attr($map->get_name()); ?>"
             data-frontdir-enabled="<?php echo esc_attr($map->get_frontdir_enabled()); ?>"
             ...
             data-map-type-position="<?php echo esc_attr($map->get_frontdir_align()); ?>"
        ...
        <?php
            if($map->get_frontdir_enabled()){
                Hugeit_Maps_Template_Loader::get_template( 'frontend/directions-block.php', array( 'map' => $map ) );
            }
        ?>
    </div>
