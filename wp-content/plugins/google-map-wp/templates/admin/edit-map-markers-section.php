			...
			<div class="hidden_edit_content hide">
				...
				<ul>
					...
					<li class="description_container">
						<label for="marker_description"><?php _e( 'Description', 'hugeit_maps' ); ?></label>
						...
						<ul>
							<li>
								<div class="image_block">
									<img src="<?php echo HUGEIT_MAPS_IMAGES_URL.'default-icon.png'; ?>" alt=""/>
								</div>
							...
							foreach( $icons as $icon ){
								...
								<li>
									<div class="image_block">
										<img src="<?php echo HUGEIT_MAPS_IMAGES_URL.'icons/'.$icon.'48.png'; ?>" />
									</div>
									<input type="radio" class="marker_image_change_marker marker_image_choose_button" name="marker_image_change" value="<?php echo $icon; ?>"/>
								</li>
								<?php
							}
		...
		<form action="" method="post">
			...
			<div class="update_list_item hide">
				...
				<ul>
					...
					<li class="description_container">
						<label for="marker_edit_description"><?php _e( 'Description', 'hugeit_maps' ); ?></label>
					...
					<li class="marker_image_choose">
						<ul>
							<li>
								...
								<input type="radio" class="marker_image_change_marker marker_image_choose_button" name="marker_edit_image_change" value="default"/>
							</li>
							<?php
							$icons = Hugeit_Maps_Marker::get_default_icons();
							...
							foreach( $icons as $icon ){
								...
								<li>
									...
									<input type="radio" class="marker_image_choose_button" name="marker_edit_image_change" value="<?php echo $icon; ?>"/>
								</li>
								<?php
							}
							?>
