                ...
                <div class="hidden_edit_content hide">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="text" class="jscolor polyline_options_input" name="hover_polyline_line_color"
                ...
                <div class="update_list_item hide">
                    ...
                    <ul>
                        ...
                        <li class="has_background">
                            ...
                            <input type="text" class="jscolor polyline_options_input" name="hover_polyline_edit_line_color"
