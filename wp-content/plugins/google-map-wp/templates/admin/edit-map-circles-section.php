                ...
                <div class="hidden_edit_content hide">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="text" class="jscolor circle_options_input" id="hover_circle_fill_color"
                        ...
                        <li>
                            ...
                            <input type="text" class="jscolor circle_options_input" id="hover_circle_line_color"
                ...
                <div class="update_list_item hide">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="text" class="jscolor circle_options_input" id="hover_circle_edit_fill_color"
                        ...
                        <li>
                            ...
                            <input type="text" class="jscolor circle_options_input" id="hover_circle_edit_line_color"
