...
class Hugeit_Maps_Install {
     ...
     * @var bool
     */
    private static $needs_columns_update;
	...
	public static function install() {
		...
		$new_columns=array(
		    Hugeit_Maps()->get_table_name( 'maps' )=>array(
		        'frontdir_enabled'=>'INT DEFAULT 1',
                'frontdir_align'=>'VARCHAR(7) NOT NULL DEFAULT "left"',
                'dir_window_width'=>'INT DEFAULT 400',
                'animation'=>'varchar(100) NOT NULL DEFAULT "none"',
                'open_infowindows_onload'=>'INT DEFAULT 0',
	...
	private static function create_tables() {
		...
		$wpdb->query(
			"CREATE TABLE IF NOT EXISTS " . $wpdb->prefix . "hugeit_maps_maps(
				...
				animation varchar(100) NOT NULL DEFAULT 'none',
				open_infowindows_onload int(2) NOT NULL DEFAULT '0',
				frontdir_enabled int(2) NOT NULL DEFAULT '0',
				frontdir_align varchar(10) NOT NULL DEFAULT 'left',
				dir_window_width int(5) UNSIGNED DEFAULT '400',
	...
	private static function insert_default_map(){
        ...
        $map
            ...
            ->set_animation( 'none' )
            ->set_frontdir_enabled(0)
            ->set_dir_window_width(400)
            ->set_frontdir_align('left')
            ->set_open_infowindows_onload(0)
