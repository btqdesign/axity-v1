...
class Hugeit_Maps_Map implements Hugeit_Maps_Map_Interface {
    ...
    /**
     * Enable Frontend Directions for map
     *
     * @values [1,0]
     * @var  int
     */
    private $frontdir_enabled;
    ...
    /**
     * Frontend Directions Box alignment for map
     *
     * @values ['left','right','top']
     * @var  string
     */
    private $frontdir_align;

    /**
     * Directions Box Width for map
     *
     * @var  int
     */
    private $dir_window_width;
     ...
     * @return int
     */
    public function get_frontdir_enabled() {
        return $this->frontdir_enabled;
    }
    ...
    /**
     * @param int $frontdir_enabled
     * @return Hugeit_Maps_Map
     * @throws Exception
     */
    public function set_frontdir_enabled( $frontdir_enabled ) {
        if ( ! in_array( $frontdir_enabled, array( 0, 1 ) ) ) {
            throw new Exception( 'Invalid value for "frontdir_enabled" field' );
        }

        $this->frontdir_enabled = (int) $frontdir_enabled;
     ...
     * @return string
     */
    public function get_frontdir_align() {
        return $this->frontdir_align;
    }

    /**
     * @param string $frontdir_align
     * @return Hugeit_Maps_Map
     * @throws Exception
     */
    public function set_frontdir_align( $frontdir_align ) {
        if ( ! in_array( $frontdir_align, array( 'bottom','left','right' ) ) ) {
            throw new Exception( 'Invalid value for "frontdir_align" field' );
        }

        $this->frontdir_align =  $frontdir_align;
     ...
     * @return int
     */
    public function get_dir_window_width() {
        return $this->dir_window_width;
    }

    /**
     * @param int $dir_window_width
     * @return Hugeit_Maps_Map
     * @throws Exception
     */
    public function set_dir_window_width( $dir_window_width ) {
        if ( ! absint( $dir_window_width) ) {
            throw new Exception( 'Invalid value for "dir_window_width" field' );
        }

        $this->dir_window_width = (int) $dir_window_width;
	...
	public function set_info_type( $info_type ) {
		...
		if ( ! in_array( $info_type, array( 'click', 'hover' , 'load' ) ) ) {
	...
	/**
	 * 
	 map data, does not save markers,polygons,polylines,circles and directions
	 */
	...
	public function save($map_id=null) {
		...
		$this->set_if_not_null( 'frontdir_enabled', $this->frontdir_enabled, $map_data );
        $this->set_if_not_null( 'locator_enabled', $this->locator_enabled, $map_data );
		$this->set_if_not_null( 'frontdir_align', $this->frontdir_align, $map_data );
		$this->set_if_not_null( 'dir_window_width', $this->dir_window_width, $map_data );
