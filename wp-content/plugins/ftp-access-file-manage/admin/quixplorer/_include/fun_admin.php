...
require MPATH_WITFTP_QX."/_include/permissions.php";
...
function admin($admin, $dir)
{
	...
	include MPATH_WITFTP_QX."/_include/js_admin.php";
...
function adduser ($dir)
{
	...
	// Javascript functions:
	include MPATH_WITFTP_QX."/_include/js_admin2.php";
...
function edituser($dir)
{
	...
	// Javascript functions:
	include MPATH_WITFTP_QX."/_include/js_admin3.php";
