...
$(document).ready(function () {
	...
	function loadPageFromPdf(pdf, pageIndex) {
		...
		pdf.getPage(creatingPage).then(function getPage(page) {
			...
			var pageName = "page" + creatingPage.toString()
			...
			setOptionValue("thumbnailHeight", 100*viewport.height/viewport.width);
				...
				var thumbName = "thumb" + creatingPage.toString()
				renderPdfPage(page, .3, thumbName, function(){
					...
					var pageItem = createPageHtml("pages["+pagesCount+"]", currentPage,"page "+currentPage, pluginDir+"books/"+bookName+"/page"+creatingPage+".jpg", pluginDir+"books/"+bookName+"/thumb"+creatingPage+".jpg","");
					pageItem.appendTo(pagesContainer);
					$(".tabs").tabs();
					addListeners();
